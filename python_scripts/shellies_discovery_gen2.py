...
MODEL_BLU_RC_BUTTON_4_US_ZB = "SBBT-104CUS"
...
BTH_DEV_MAP = {
    ...
    8: MODEL_BLU_TRV,
    22: MODEL_BLU_RC_BUTTON_4_US_ZB,
}
...
SUPPORTED_MODELS = {
    ...
    MODEL_BLU_RC_BUTTON_4_US_ZB: {
        ATTR_NAME: "Shelly BLU RC Button 4 US ZB",
        ATTR_MODEL_ID: MODEL_BLU_RC_BUTTON_4_US_ZB,
        ATTR_SENSORS: {
            SENSOR_SIGNAL_STRENGTH: DESCRIPTION_SENSOR_BTH_DEV_SIGNAL_STRENGTH,
            SENSOR_BATTERY: DESCRIPTION_SENSOR_BTH_DEV_BATTERY,
        },
