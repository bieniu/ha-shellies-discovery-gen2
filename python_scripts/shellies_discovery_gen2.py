...
MODEL_PLUG_M_G3 = "shellyplugmg3"
MODEL_PLUG_PM_G3 = "shellyplugpmg3"
...
SENSOR_CHARGER_STATE = "charger_state"
SENSOR_CLOUD = "cloud"
...
SENSOR_PHASE_A_CURRENT = "phase_a_current"
SENSOR_PHASE_A_POWER = "phase_a_power"
SENSOR_PHASE_A_VOLTAGE = "phase_a_voltage"
SENSOR_PHASE_B_CURRENT = "phase_b_current"
SENSOR_PHASE_B_POWER = "phase_b_power"
SENSOR_PHASE_B_VOLTAGE = "phase_b_voltage"
SENSOR_PHASE_C_CURRENT = "phase_c_current"
SENSOR_PHASE_C_POWER = "phase_c_power"
SENSOR_PHASE_C_VOLTAGE = "phase_c_voltage"
SENSOR_POWER = "power"
...
SENSOR_SCRIPT_RUNNING = "script_running"
...
TOPIC_STATUS_OCCUPANCY = "~status/occupancy:0"
TOPIC_ONLINE = "~online"
TOPIC_RPC = "~rpc"
...
BTH_DEV_MAP = {
    ...
    8: MODEL_BLU_TRV,
    17: MODEL_BLU_HT_ZB,
    12: MODEL_BLU_HT_DISPLAY_ZB,
    22: MODEL_BLU_RC_BUTTON_4_ZB,
}
...
DESCRIPTION_SENSOR_OCCUPANCY = {
    KEY_DEVICE_CLASS: DEVICE_CLASS_OCCUPANCY,
    KEY_ENABLED_BY_DEFAULT: True,
    KEY_NAME: "Occupancy",
    KEY_STATE_TOPIC: TOPIC_STATUS_OCCUPANCY,
...
DESCRIPTION_SENSOR_BTH_LIGHT = {
    KEY_DEVICE_CLASS: DEVICE_CLASS_LIGHT,
    KEY_ENABLED_BY_DEFAULT: True,
    KEY_NAME: "Light",
    KEY_STATE_TOPIC: TOPIC_STATUS_BTH_SENSOR,
    KEY_VALUE_TEMPLATE: TPL_BTH_BINARY_SENSOR,
...
SUPPORTED_MODELS = {
    ...
    MODEL_BLU_RC_BUTTON_4_ZB: {
        ATTR_NAME: "Shelly BLU RC Button 4 ZB",
        ATTR_MODEL_ID: MODEL_BLU_RC_BUTTON_4_ZB,
        ATTR_SENSORS: {
            SENSOR_SIGNAL_STRENGTH: DESCRIPTION_SENSOR_BTH_DEV_SIGNAL_STRENGTH,
            SENSOR_BATTERY: DESCRIPTION_SENSOR_BTH_DEV_BATTERY,
        },
    ...
    MODEL_BLU_HT_ZB: {
        ATTR_NAME: "Shelly BLU H&T ZB",
        ATTR_MODEL_ID: "SBHT-203C",
        ATTR_SENSORS: {
            SENSOR_TEMPERATURE: DESCRIPTION_SENSOR_BTH_TEMPERATURE,
            SENSOR_HUMIDITY: DESCRIPTION_SENSOR_BTH_HUMIDITY,
            SENSOR_SIGNAL_STRENGTH: DESCRIPTION_SENSOR_BTH_DEV_SIGNAL_STRENGTH,
    ...
    MODEL_BLU_HT_DISPLAY_ZB: {
        ATTR_NAME: "Shelly BLU H&T Display ZB",
        ATTR_MODEL_ID: "SBHT-103C",
        ATTR_BINARY_SENSORS: {SENSOR_LIGHT: DESCRIPTION_SENSOR_BTH_LIGHT},
        ATTR_SENSORS: {
            SENSOR_TEMPERATURE: DESCRIPTION_SENSOR_BTH_TEMPERATURE,
            SENSOR_HUMIDITY: DESCRIPTION_SENSOR_BTH_HUMIDITY,
            SENSOR_SIGNAL_STRENGTH: DESCRIPTION_SENSOR_BTH_DEV_SIGNAL_STRENGTH,
    ...
    MODEL_PLUG_M_G3: {
        ATTR_NAME: "Shelly Plug M Gen3",
        ATTR_MODEL_ID: "S3PL-30110EU",
        ATTR_GEN: 3,
        ATTR_BINARY_SENSORS: {SENSOR_CLOUD: DESCRIPTION_SENSOR_CLOUD},
        ATTR_BUTTONS: {BUTTON_RESTART: DESCRIPTION_BUTTON_RESTART},
        ATTR_RELAYS: 1,
    ...
    MODEL_PLUG_PM_G3: {
        ATTR_NAME: "Shelly Plug PM Gen3",
        ATTR_MODEL_ID: "S3PL-30116EU",
        ATTR_GEN: 3,
        ATTR_BINARY_SENSORS: {SENSOR_CLOUD: DESCRIPTION_SENSOR_CLOUD},
        ATTR_BUTTONS: {BUTTON_RESTART: DESCRIPTION_BUTTON_RESTART},
        ATTR_SENSORS: {
    ...
    MODEL_PLUG_US_G4: {
        ...
        ATTR_MIN_FIRMWARE_DATE: 20251021,
    },
    MODEL_PRESENCE_G4: {
    ...
    MODEL_WALL_DISPLAY: {
        ...
        ATTR_MODEL_ID: "SAWD-xA1XX10EUx",
        ATTR_BINARY_SENSORS: {
            SENSOR_CLOUD: DESCRIPTION_SLEEPING_SENSOR_CLOUD,
            SENSOR_OCCUPANCY: DESCRIPTION_SENSOR_OCCUPANCY,
        },
        ATTR_BUTTONS: {BUTTON_RESTART: DESCRIPTION_BUTTON_RESTART},
        ATTR_INPUT_BINARY_SENSORS: {SENSOR_INPUT: DESCRIPTION_SENSOR_INPUT},
        ATTR_INPUT_EVENTS: [
        ...
        ATTR_MIN_FIRMWARE_DATE: 20260515,
    },
    MODEL_X_MOD1: {
    ...
    MODEL_FLOOD_S_G4: {
        ATTR_BATTERY_POWERED: True,
        ATTR_NAME: "Shelly Flood S Gen4",
        ATTR_MODEL_ID: "S4SN-0071Z",
        ATTR_GEN: 4,
        ATTR_BINARY_SENSORS: {
            SENSOR_ALARM_SOUND: DESCRIPTION_SENSOR_FLOOD_ALARM_SOUND,
            SENSOR_CLOUD: DESCRIPTION_SLEEPING_SENSOR_CLOUD,
        ...
        ATTR_MIN_FIRMWARE_DATE: 20260115,
        ATTR_WAKEUP_PERIOD: 43200,
    },
    MODEL_ST1820: {
    ...
    MODEL_TOPAC_EVE01_11R: {
        ATTR_NAME: "TopAC EVE01-11R",
        ...
        ATTR_SENSORS: {
            ...
            SENSOR_PHASE_A_VOLTAGE: DESCRIPTION_SENSOR_TOPAC_PHASE_A_VOLTAGE,
            SENSOR_PHASE_B_CURRENT: DESCRIPTION_SENSOR_TOPAC_PHASE_B_CURRENT,
            SENSOR_PHASE_B_POWER: DESCRIPTION_SENSOR_TOPAC_PHASE_B_POWER,
            SENSOR_PHASE_B_VOLTAGE: DESCRIPTION_SENSOR_TOPAC_PHASE_B_VOLTAGE,
        ...
        ATTR_MIN_FIRMWARE_DATE: 20250821,
    },
}
...
def get_script_binary_sensor(script_id):
    """Create configuration for Shelly script running binary sensor."""
    topic = encode_config_topic(
        f"{disc_prefix}/binary_sensor/{device_id}-script-{script_id}-running/config"
    )

    payload = {
        KEY_NAME: f"Script {script_id}",
        KEY_DEVICE_CLASS: DEVICE_CLASS_RUNNING,
        KEY_ENABLED_BY_DEFAULT: str(
            DESCRIPTION_SENSOR_SCRIPT_RUNNING[KEY_ENABLED_BY_DEFAULT]
        ).lower(),
        KEY_ENTITY_CATEGORY: ENTITY_CATEGORY_DIAGNOSTIC,
        KEY_STATE_TOPIC: TOPIC_SCRIPT.format(id=script_id),
        KEY_VALUE_TEMPLATE: TPL_SCRIPT_RUNNING,
        KEY_UNIQUE_ID: f"{device_id}-script-{script_id}-running".lower(),
        KEY_QOS: qos,
        KEY_DEVICE: device_info,
        KEY_ORIGIN: origin_info,
        KEY_DEFAULT_TOPIC: default_topic,
...
def get_script_sensor(script_id, sensor, description):
    """Create configuration for Shelly script memory sensor."""
    topic = encode_config_topic(
        f"{disc_prefix}/sensor/{device_id}-script-{script_id}-{sensor}/config"
    )

    payload = {
        KEY_NAME: description[KEY_NAME].format(id=script_id),
        KEY_ENABLED_BY_DEFAULT: str(description[KEY_ENABLED_BY_DEFAULT]).lower(),
        KEY_ENTITY_CATEGORY: description[KEY_ENTITY_CATEGORY],
        KEY_STATE_TOPIC: TOPIC_SCRIPT.format(id=script_id),
        KEY_VALUE_TEMPLATE: description[KEY_VALUE_TEMPLATE],
        KEY_UNIQUE_ID: f"{device_id}-script-{script_id}-{sensor}".lower(),
        KEY_QOS: qos,
        KEY_DEVICE: device_info,
        KEY_ORIGIN: origin_info,
        KEY_DEFAULT_TOPIC: default_topic,
...
def configure_device():
    ...
    for script_id in get_component_ids("script", device_config):
        topic, payload = get_script_binary_sensor(script_id)
        config[topic] = payload
        ...
        for sensor, description in (
            ...
            topic, payload = get_script_sensor(script_id, sensor, description)
            config[topic] = payload
